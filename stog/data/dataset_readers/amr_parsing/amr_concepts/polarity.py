...
class Polarity:
    ...
    def predict_polarity(self):
        ...
        # self.amr.abstract_map.update(self.to_dict())
    ...
    def sort_node_by_distance(self, head, nodes):
        ...
        # if self.amr.id.startswith('DF-199-194215-653_0484.24'):
        #     import pdb; pdb.set_trace()
        for node in nodes:
            ...
            for instance, nodes in instances.items():
                if self.is_match(head, instance):
                    ...
                    if match != correct:
                        print(amr)
                        print(self)
                        print('Head: {}'.format(self.amr.lemmas[head]))
                        print('Matched node:')
                        print(node)
                        print('No. {}'.format(self.i))
                        import pdb; pdb.set_trace()
    ...
    def is_match(self, index, instance):
        ...
        # if self.amr.id.startswith('wb.eng_0003.27'):
        #     import pdb; pdb.set_trace()
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser('polarity.py')
