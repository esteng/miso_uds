...
from stog.data.dataset_readers.dataset_reader import \
    DatasetReader
...
from stog.data.dataset_readers.penn_tree_bank import \
...
from stog.data.dataset_readers.semantic_role_labeling import \
    SrlReader
from stog.data.dataset_readers.semantic_dependency_parsing import \
    SemanticDependenciesDatasetReader
from stog.data.dataset_readers.seq2seq import \
...
from stog.data.dataset_readers.universal_dependencies import \
    UniversalDependenciesDatasetReader
from stog.data.dataset_readers.abstract_meaning_representation import \
