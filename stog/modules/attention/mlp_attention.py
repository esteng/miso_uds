...
class MLPAttention(torch.nn.Module):
    ...
    def __init__(self, decoder_hidden_size, encoder_hidden_size, attention_hidden_size, coverage=False):
    ...
    def forward(self, decoder_input, encoder_input, coverage=None):
        ...
        batch_size, encoder_seq_length, decoder_hidden_size = encoder_input.size()
