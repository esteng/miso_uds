...
class Model(torch.nn.Module):
    ...
    def get_parameters_for_himisoram_tensorboard_logging( # pylint: disable=invalid-name
            self) -> List[str]:
        """
        Returns the name of model parameters used for logging himisorams to tensorboard.
        """
