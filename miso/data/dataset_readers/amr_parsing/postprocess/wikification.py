        ...
        for node in graph.get_nodes():
            ...
            if instance in abstract_map:
                ...
                if instance_type == 'named-entity':
                    ...
                    # ref = graph.get_name_node_wiki(node)
                    # if wiki != ref:
                    #     if not ref in list(cached_wiki.values()):
                    #         continue
                    #     if wiki != '-':
                    #         continue
                    #     print(amr_type)
                    #     print(strip(saved_dict['span']) + '\t' + span)
                    #     print('pred: ' + wiki + '\tgold: ' + ref)
                    #     print(cached_wiki)
                    #     print('')
                    # else:
                    #     self.correct_wikification_count += 1
