...
for lang in af de fr fi hu gl; do
    ...
    python miso/metrics/conllu.py \
        ...
        /exp/estengel/miso_res/ud_models_vocab/transformer/${lang}/dev.conllu
    echo "${lang} ENCODER" 
    python miso/metrics/conllu.py \
        /exp/estengel/ud_data/all_data/dev/${lang}-universal.conllu \
        /exp/estengel/miso_res/ud_models_vocab/transformer_pretrained/${lang}_encoder/dev.conllu
