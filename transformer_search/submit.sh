...
idx=$SGE_TASK_ID
opt_file=/home/hltcoe/estengel/miso_research/transformer_search/opt.txt
...
OG_TRAIN_CONFIG=transformer_search/configs/decomp_transformer_syntax_search.jsonnet
