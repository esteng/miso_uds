...
#$ -q gpu.q@@2080
#$ -cwd
#$ -o /home/hltcoe/estengel/miso_research/transformer_search/logs/tune_transformer_xlmr.out
#$ -t 1:40:1
#$ -tc 4

idx=$SGE_TASK_ID
opt_file=/home/hltcoe/estengel/miso_research/transformer_search/opt_part_7.txt
...
CHECKPOINT_DIR=/exp/estengel/miso_res/xlmr_tuning/${dash_args}.ckpt 

#OG_TRAIN_CONFIG=transformer_search/configs/part7.jsonnet
OG_TRAIN_CONFIG=transformer_search/configs/xlmr.jsonnet
