...
idx=$SGE_TASK_ID
opt_file=/home/hltcoe/estengel/miso_research/transformer_search/opt_part_8.txt
...
CHECKPOINT_DIR=/exp/estengel/miso_res/encoder_tuning/${dash_args}.ckpt 

OG_TRAIN_CONFIG=transformer_search/configs/part8.jsonnet
