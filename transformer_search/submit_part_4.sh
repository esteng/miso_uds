...
#$ -q gpu.q@@2080
#$ -cwd
#$ -o /home/hltcoe/estengel/miso_research/transformer_search/logs/tune_transformer_part4.out
#$ -t 1:40:1

idx=$SGE_TASK_ID
opt_file=/home/hltcoe/estengel/miso_research/transformer_search/opt_part_4.txt
...
OG_TRAIN_CONFIG=transformer_search/configs/part4.jsonnet
