...
#$ -q gpu.q@@2080
#$ -cwd
#$ -o /home/hltcoe/estengel/miso_research/transformer_search/logs/tune_transformer_part3.out
#$ -t 1:5:1

idx=$SGE_TASK_ID
opt_file=/home/hltcoe/estengel/miso_research/transformer_search/opt_part_3.txt
...
OG_TRAIN_CONFIG=transformer_search/configs/part3.jsonnet

TRAINING_CONFIG=transformer_search/configs/${dash_args}.jsonnet

cp ${OG_TRAIN_CONFIG} ${TRAINING_CONFIG}

transformer_search/read_and_replace_part_3.sh ${TRAINING_CONFIG} ${args} 
