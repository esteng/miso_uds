...
#$ -q gpu.q@@2080
#$ -cwd
#$ -o /home/hltcoe/estengel/miso_research/transformer_search/logs/tune_transformer.out
#$ -t 1:33:1
#$ -tc 3

idx=$SGE_TASK_ID
opt_file=/home/hltcoe/estengel/miso_research/transformer_search/opt_part_9.txt
...
CHECKPOINT_DIR=/exp/estengel/miso_res/transformer_fix_tuning/${dash_args}.ckpt 

OG_TRAIN_CONFIG=transformer_search/configs/part9.jsonnet
