...
def test_xlmr_overfit():
    config_path = os.path.join(test_path, "configs", "overfit_decomp_xlmr.jsonnet") 
    output_dir = os.path.join(test_path, "checkpoints", "overfit_decomp_xlmr.ckpt") 
