...
def test_decomp_accumulate():
    config_path = os.path.join(test_path, "configs", "overfit_decomp_accumulate.jsonnet") 
    output_dir = os.path.join(test_path, "checkpoints", "overfit_decomp_accumulate.ckpt") 
