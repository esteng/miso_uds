...
def test_bert_no_tune_overfit():
    config_path = os.path.join(test_path, "configs", "overfit_decomp_bert_notune.jsonnet") 
    output_dir = os.path.join(test_path, "checkpoints", "overfit_decomp_bert_notune.ckpt") 
...
#def test_roberta_overfit():
#    config_path = os.path.join(test_path, "configs", "overfit_decomp_roberta.jsonnet") 
#    output_dir = os.path.join(test_path, "checkpoints", "overfit_decomp_roberta.ckpt") 
#
#    test_args = setup_checkpointing_and_args(config_path, output_dir) 
#    train_model_from_file(test_args.param_path,
#                          test_args.serialization_dir)
